// =====================================================================
// KRAKEN MEDALLION v8 - two-material relief.
//
...
// The relief, split for two-material printing. kraken() is their union and
// is geometrically identical to v7's single kraken_wrap_bored.stl.
module kraken_body()    { import("kraken_body.stl"); }      // kraken filament
module kraken_accents() { import("kraken_accents.stl"); }   // SHELL filament
module kraken() { kraken_body(); kraken_accents(); }
